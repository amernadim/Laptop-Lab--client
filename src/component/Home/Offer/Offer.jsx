...
const Offer = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-gray-800 text-gray-100 backdrop-blur-xl mt-10">
    <h2 className="mb-8 text-3xl font-bold leading-none text-center">What do we have to offer?</h2>
