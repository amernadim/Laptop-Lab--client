      ...
      <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Wonderful service. You are getting the most money out of your old
              tech from this website, it’s super easy to do as well
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
          ...
          <span className="w-12 h-1 my-2 rounded-lg  bg-gradient-to-br from-lime-500 via-lime-600 to-green-700"></span>
          <p>Jhankar Mahbub</p>
        </div>
        <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              {" "}
              They gave me a pretty good price for my laptop I was going to
              sell.They answered all the questions that I had and the payment
              was prompt, very happy !
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
